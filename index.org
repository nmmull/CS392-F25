...
+ Reading:
  ...
  + [[https://rustc-dev-guide.rust-lang.org/getting-started.html][Rust Compiler Development Guide]]
...
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 14][10-21]] | Miscellany: Modules, Testing                |                         |
...
| [[*Meeting 17][10-30]] | Concurrency II: Asynchronous Programming    | [[file:Assignments/final-project-outline.org][FP outline out]], A6 due  |
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 18][11-04]] | Unsafe Rust I: An Introduction              |                         |
| [[*Meeting 19][11-06]] | Unsafe Rust II: Implementing ~Rc<T>~        | FP outline due          |
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 20][11-11]] | Theory V: Boxes and Lifetimes (salt3)       |                         |
| [[*Meeting 21][11-13]] | Theory VI: Boxes and Lifetimes (salt4)      | FP check-in 1           |
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 22][11-18]] | Theory VII: Type/Borrow Safety              |                         |
| [[*Meeting 23][11-20]] | Miscellany II: The Compiler                 | FP check-in 2           |
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 24][11-25]] | Miscellany III : Macros                     |                         |
| 11-27 | *NO CLASS*                                  | Thanksgiving            |
|-------+---------------------------------------------+-------------------------|
| [[*Meeting 25][12-02]] | Miscellany IV: Stacked Borrows              |                         |
| [[*Meeting 26][12-04]] | Miscellany V: OxCaml                        |                         |
|-------+---------------------------------------------+-------------------------|
...
*** Material: [[file:notes/salt2.pdf][salt2.pdf]]
** Meeting 12
...
*** Material:
**** Slides: [[file:Slides/14-async.pdf][14-async.pdf]]
**** Assignment: [[file:Assignments/final-project-outline.org][final-project-outline.html]]
* Week 10: Unsafe ✓
** Meeting 18
*** Title: *An Introduction*
**** Reading:
***** [[https://doc.rust-lang.org/stable/book/ch20-01-unsafe-rust.html][RPL 20.1: Unsafe Rust]]
***** [[https://doc.rust-lang.org/nomicon/meet-safe-and-unsafe.html][Rustonomicon 1: Meet Safe and Unsafe]]
***** [[https://rust-unofficial.github.io/too-many-lists/fifth-miri.html][LRWETMLL 6.4: Miri]]
**** Material:
***** Slides: [[file:Slides/15-unsafe.pdf][15-unsafe.pdf]]
** Meeting 19
*** Title: *Implementing ~Rc<T>~*
**** Reading:
***** [[https://doc.rust-lang.org/nomicon/subtyping.html][Rustonomicon 3.8: Subtyping and Variance]]
***** [[https://doc.rust-lang.org/nomicon/dropck.html][Rustonomicon 3.9: Drop Check]]
***** [[https://doc.rust-lang.org/nomicon/phantom-data.html][Rustonomicon 3.10: PhantomData]]
***** [[https://doc.rust-lang.org/nomicon/vec/vec.html][Rustonomicon 10: Implementing Vec]]
***** [[https://doc.rust-lang.org/std/rc/struct.Rc.html][std::rc::Rc]]
***** [[https://doc.rust-lang.org/std/ptr/struct.NonNull.html][std::ptr::NonNull]]
***** [[https://doc.rust-lang.org/std/marker/struct.PhantomData.html][std::marker::PhantomData]]
**** Material: [[file:Code/rc.zip][rc.zip]]
* Week 11: Theory ✓
** Meeting 20
*** Title: *Boxes and Lifetimes I*
**** Reading: [[https://github.com/nmmull/salt392/blob/main/lib/salt3/spec/salt3.pdf][salt3.pdf]]
** Meeting 21
*** Title: *Boxes and Lifetimes II*
**** Reading: [[https://github.com/nmmull/salt392/blob/main/lib/salt4/spec/salt4.pdf][salt4.pdf]]
* Week 12: Compiler ✓
** Meeting 22
*** Title: *Type/Borrow Safety*
** Meeting 23
*** Title: *The Compiler*
**** Reading:
***** [[https://rustc-dev-guide.rust-lang.org/overview.html][RCDG 29: Overview of the compiler]]
***** [[https://rustc-dev-guide.rust-lang.org/part-3-intro.html][RCDG 38: Source Code Representation]]
***** [[https://rustc-dev-guide.rust-lang.org/part-4-intro.html][RCDG 47: Analysis]]
**** Slides: [[file:Slides/compiler.pdf][compiler.pdf]]
* Week 13: Macros ✓
** Meeting 24
*** Title: *An Overview*
**** Reading: [[https://doc.rust-lang.org/stable/book/ch20-05-macros.html][RPL 20.5: Macros]]
**** Slides: [[file:Slides/macros.pdf][macros.pdf]]
* Week 14: Miscellany ✓
** Meeting 25
*** Title: *Stacked Borrows*
**** Reading:
***** [[https://rust-unofficial.github.io/too-many-lists/fifth-stacked-borrows.html][LRWETMLL 6.5: Stacked Borrows]]
***** [[https://plv.mpi-sws.org/rustbelt/stacked-borrows/][Stacked Borrows: An Aliasing Model for Rust]]
** Meeting 26
*** Title: *Show and Tell*
